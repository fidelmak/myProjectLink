...
<section className="bg-white dark:bg-gray-900">
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
    ...
    <label for="checked-checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">You agree to providing your data to Dpaul who may contact you.</label>
        </span>
          <button onClick={handleClick} type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg w-full bg-blue-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
      </form>
  </div>
  <Footer />
</section>
